...
const PlayerCard = ({ personalCard, user, calculatePayouts, totalScore, totalWinnings, isLoggedInUser, secretScoreboard, getPlayerScore, getPlayerPosition, getPlayerThruStatus, abbreviateNumber }) => {
